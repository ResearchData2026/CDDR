...
Each product run produces both a MAS CDDR and a single-LLM baseline CDDR for structural comparison.


Licence
Code is released under the MIT Licence. Data outputs are released under Creative Commons Attribution 4.0 International (CC BY 4.0). See LICENSE.md for full terms.
